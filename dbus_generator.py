...
class Generator:
	def __init__(self):
		...
		settingsbase = {
			...
			'stopwhengridavailable': ['/Settings/{0}/StopWhenGridAvailable', 0, 0, 0],
			'accumulateddaily': ['/Settings/{0}/AccumulatedDaily', '', 0, 0],
			'accumulatedtotal': ['/Settings/{0}/AccumulatedTotal', 0, 0, 0],
